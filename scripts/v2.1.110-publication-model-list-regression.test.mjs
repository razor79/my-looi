...
assert.match(settings, /Предыдущие модели/);
assert.match(settings, /Рекомендуем · Лучшее соотношение цены и качества/);
assert.match(settings, /Максимальное качество/);
